    ...
    >
      <DialogContent className="sm:max-w-200 max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div
                        key={template.id}
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 
                          hover:scale-[1.02]
                          ${
                            selectedTemplate === template.id
                              ? "border-[#FF6B35]  shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)]"
                              : "hover:border-[#FF6B35] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                          }
                          `}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#FF6B35] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-[#FF6B35] hover:bg-[#cf3f3f]"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#FF6B35]">
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <Button
                className="bg-[#FF6B35] hover:bg-[#d03636]"
